    ...
    <main className="min-h-screen bg-obsidian">
                    ...
                    <div className="flex flex-col gap-1.5">
                      {done && !alreadyReviewed && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-full border border-gold/50 px-3 py-1 text-[11px] tracking-wide text-gold hover:bg-gold/10"
                        >
      ...
      {rateFor && user && (
        <RatingModal
          ...
          onSubmitted={() => {
            setReviewed((s) => new Set([...s, rateFor]));
            setRateFor(null);
          }}
        />
      )}
