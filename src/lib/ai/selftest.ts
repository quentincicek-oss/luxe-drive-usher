...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    payload: {
      ...
      facts: { flight: "AA100", terminal: "4", pickup_at: "19:00", passengers: 4, vehicle: "Escalade", distance_miles: 18 },
      requiredFacts: ["flight", "terminal", "pickup_at", "passengers", "vehicle", "distance_miles"],
      purpose: "selftest_B",
    },
  },
  {
